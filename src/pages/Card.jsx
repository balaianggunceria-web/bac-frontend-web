...
const Card = () => {
    ...
    <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16'>
     ...
     <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
         <div className='pl-4 sm:pl-0'>
           <h2 className='text-lg text-orange-500'>Rp.{p.products[0].price - Math.floor((p.products[0].price * p.products[0].discount) / 100 )}</h2>
           <p className='line-through'>Rp.{p.products[0].price}</p>
