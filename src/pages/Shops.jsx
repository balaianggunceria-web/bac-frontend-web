    ...
    return (
        ...
        <div className='py-2 flex flex-col gap-5'>
            <h2 className='text-3xl font-bold mb-3 text-slate-600'>Price</h2>
             ...
             />  
         <div>
         <span className='text-slate-800 font-bold text-lg'>Rp.{Math.floor(state.values[0])} - Rp.{Math.floor(state.values[1])}</span>  
           </div>
         </div>
        ...
        <div>
            {
             ...
             setPageNumber={setPageNumber} totalItem={totalProduct} parPage={parPage} showItem={Math.floor(totalProduct / parPage )} />
            }
         </div>
