...
import { get_reviews, product_details } from '../store/reducers/homeReducer';
...
<div className='flex text-xl'>
  ...
  <span className='text-green-500'>
    ({get_reviews || 0} reviews)
        ...
        <li>
            <a className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex justify-center items-center bg-blue-500 rounded-full text-white' href="#"> <FaLinkedin /> </a>
        </li>
        <li>
            <a className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex justify-center items-center bg-black rounded-full text-white' href="#"> <FaGithub /> </a>
        </li>
    </ul> 
    </div>
          </div>
    ...
    <div className='flex flex-col gap-5 mt-3 border p-3'>
        ...
        <Link className='block'>
            ...
            <img className='w-full h-full' src={ p.images[0]} alt="" /> 
            {
             ...
             absolute text-white w-[38px] h-[38px] rounded-full bg-red-500 font-semibold text-xs left-2 top-2'>{p.discount}%
            </div>
            }
            </div>
            ...
            <div className='flex gap-2'>
                <h2 className='text-lg font-bold text-slate-600'>Rp.{p.price}</h2>
